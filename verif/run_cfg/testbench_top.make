...
sv:
	$(COMP_SVLOG)  $(INC_DIR) -work libtest  -file $(PRJROOT)/verif/run_cfg/filelists/testbench_top_files.f

sim:	
	@echo "VCS-MX begin to compile testbench...";
	@echo "Compile for LVDS and Power Sequence Testcases";
	$(COMP_VCS)  tb_top -l cosim_elabration.log
